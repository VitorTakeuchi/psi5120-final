...
evidence for the extensions are publicly available at
\url{https://github.com/VitorTakeuchi/psi5120-final}, and the baseline (prior
work) at \url{https://github.com/VitorTakeuchi/psi5120-hpa}.
...
extensions; Section~\ref{sec:disc} discusses the combined findings;
Section~\ref{sec:threats} examines threats to validity; and
...
\begin{figure*}[!t]
\centering
\includegraphics[width=0.72\textwidth]{figuras/ext1_replicas_media_desvio.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figuras/ext3_hpa_memoria.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figuras/ext3_top_pods.png}
